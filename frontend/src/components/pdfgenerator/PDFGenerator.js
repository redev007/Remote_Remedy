...
const PDFGenerator = ({name, age, gender, selectedDoc}, prescription) => {
    ...
    pdf.text("Remote_Remedy", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("Remote_Remedy") * pdf.internal.getFontSize())), y);
    y += 30;
    ...
    y += 20;
    pdf.text("Remote_Remedy@gmail.com", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("Remote_Remedy@gmail.com") * pdf.internal.getFontSize())), y);
    y += 25;
    ...
    pdf.text("2024 @Remote_Remedy | All Rights Reserved", pdf.internal.pageSize.width - 40 - pdf.getStringUnitWidth("2024 @Remote_Remedy | All Rights Reserved") * pdf.internal.getFontSize(), pdf.internal.pageSize.height - 30);
